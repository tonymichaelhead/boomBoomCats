  ...
  return (
    <div className='gameTable'>
      ...
      <div className="row text-center">
        ...
        {props.gameOver ? <h3 id='winner'>{props.currentPlayerTurn} is the winner!</h3> : <h3 id='calculation'>You have a {Math.round((props.exploderCount / props.deck.length) * 100)}% chance of blowing up!</h3>}
      </div>
        <Player 
